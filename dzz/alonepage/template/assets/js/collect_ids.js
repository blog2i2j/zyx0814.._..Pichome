const Tmpcollect_text = {
    ...
    setup(props,context){
        ...
        async function getData(query){
            ...
            const {data: res} = await axios.post(BasicUrl+'getCollectList',{q: query,ids:[props.model[0].id]});
            if(res.success){
        ...
        <div ref="DomdragTab">
            <el-tabs
                ...
                <el-tab-pane
                    ...
                    <Tmpcollect_text :model="item.data" :typecollection="typecollection"></Tmpcollect_text>
                </el-tab-pane>
            </el-tabs>
            <el-dialog
