const Tmpcollectrec_text = {
    ...
    template:`
        <el-form label-width="150px" label-suffix=":">
            ...
            <el-form-item :label="Lang.text1">
                <el-select v-model="model[0].number" style="width:50%;">
                    <el-option
                        v-for="num in 10"
                        :key="num"
                        :label="num + Lang.text23"
                        :value="num"
                        ></el-option>
                </el-select>
            </el-form-item>
            ...
            <el-form-item :label="Lang.text15">
                <div style="width: 100%;">
                    <div style="display:flex;width:50%">
                        ...
                        <el-select v-model="model[0].link" style="width: 110px;margin-right:6px;" @change="handleMoreChange">
                            ...
                            <el-option v-if="licenseversion>1" :label="Lang.text20" value="4"></el-option>
                            <el-option :label="Lang.text22" value="5"></el-option>
                        </el-select>
    ...
    setup(props,context){
        ...
        async function getData(query){
            ...
            const {data: res} = await axios.post(BasicUrl+'getCollectList',{q: query,ids:[props.model[0].ids]});
            if(res.success){
        ...
        function handleMoreChange( val){
            props.model[0].linkval='';
            if( val == '5'){
                getPublishList();
            }
        }
        ...
        <div ref="DomdragTab">
            <el-tabs
                ...
                <el-tab-pane
                    ...
                    <Tmpcollectrec_text :model="item.data" :typecollection="typecollection"></Tmpcollectrec_text>
                </el-tab-pane>
            </el-tabs>
            <el-dialog
