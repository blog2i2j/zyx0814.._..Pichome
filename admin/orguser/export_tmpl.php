...
if (!defined('IN_OAOOA') || !defined('IN_ADMIN') || !defined('PICHOME_LIENCE')) {
	...
	// $h0=array('nickname'=>lang('nickname'),'username'=>lang('username'),'email'=>lang('email'),'password'=>lang('user_login_password'),'birth'=>lang('date_birth'),'gender'=>lang('gender'),'mobile'=>lang('cellphone'),'weixinid'=>lang('weixin'),'orgname'=>lang('category_department'),'job'=>lang('department_position'));
	$h0=array('nickname'=>lang('nickname'),'username'=>lang('username'),'email'=>lang('email'),'password'=>lang('user_login_password'),'birth'=>lang('date_birth'),'gender'=>lang('gender'),'mobile'=>lang('cellphone'),'weixinid'=>lang('weixin'),'orgname'=>lang('category_department'));
	...
	$objPHPExcel->getProperties()->setCreator($_G['username'])
								 ...
								 ->setSubject($title)
								 ->setDescription($title.' Export By oaooa  '.date('Y-m-d H:i:s'))
								 ->setKeywords($title)
								 ->setCategory($title);
	$list=array();
	...
	foreach($h0 as $key =>$value){
		...
		if($key=='username' || $key=='nickname' || $key=='email'){
